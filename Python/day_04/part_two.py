...
def get_card_copies(card_array: list[tuple[list[int], list[int]]], card_info: tuple[list[int], list[int])
...
if __name__ == '__main__':
    part_one_answer = part_two("input.txt")
    print("Part two:", part_one_answer)
